...
def get_seed_payload() -> dict[str, Any]:
    ...
    return {
        ...
        "journal_entries": [
            {"id": "1", "createdAt": "2026-04-23T06:35:00+05:30", "date": "23 April, 2026", "time": "6:35 AM", "title": "Morning Clarity", "excerpt": "Woke up feeling exceptionally refreshed today. The new sleep routine is clearly working...", "content": "Woke up feeling exceptionally refreshed today. The new sleep routine is clearly working, and I want to protect the evening wind-down because it is making mornings feel lighter.", "mood": "Happy", "tags": ["Sleep", "Mindfulness"], "source": "manual"},
            {"id": "2", "createdAt": "2026-04-22T07:10:00+05:30", "date": "22 April, 2026", "time": "7:10 AM", "title": "Post-Workout Reflection", "excerpt": "Felt strong during the session, but noticed some tightness in the lower back. Need to focus on mobility tomorrow...", "content": "Felt strong during the session, but noticed some tightness in the lower back. Need to focus on mobility tomorrow and treat the tightness as useful feedback instead of a setback.", "mood": "Productive", "tags": ["Fitness", "Reflection"], "source": "manual"},
            {"id": "3", "createdAt": "2026-04-21T20:45:00+05:30", "date": "21 April, 2026", "time": "8:45 PM", "title": "Balanced Diet Struggles", "excerpt": "Had a slight slip up with the diet today at the office party. Choosing to forgive myself and get back on track...", "content": "Had a slight slip up with the diet today at the office party. Choosing to forgive myself and get back on track with the planned breakfast tomorrow.", "mood": "Neutral", "tags": ["Diet", "Self-Care"], "source": "manual"},
        ],
        "journal_cbt_notes": [
            {"id": "diet-slip", "createdAt": "2026-04-22T20:45:00+05:30", "date": "22 April, 2026", "time": "8:45 PM", "situation": "Office party diet slip-up", "thought": "I ruined my progress.", "feeling": "Guilt, frustration", "reframe": "One meal does not erase weeks of consistency.", "action": "Return to the planned breakfast tomorrow.", "source": "manual", "linkedEntryId": "3"},
            {"id": "back-tightness", "createdAt": "2026-04-22T07:10:00+05:30", "date": "22 April, 2026", "time": "7:10 AM", "situation": "Lower back felt tight after training", "thought": "My body is holding me back.", "feeling": "Concern, impatience", "reframe": "This is useful feedback, not failure.", "action": "Choose mobility work before the next hard session.", "source": "manual", "linkedEntryId": "2"},
            {"id": "sleep-routine", "createdAt": "2026-04-23T06:35:00+05:30", "date": "23 April, 2026", "time": "6:35 AM", "situation": "New sleep routine is helping", "thought": "I need to protect this momentum.", "feeling": "Calm, encouraged", "reframe": "Small repeatable routines are already working.", "action": "Keep the evening wind-down light and predictable.", "source": "manual", "linkedEntryId": "1"},
        ],
        "biomarkers": [
